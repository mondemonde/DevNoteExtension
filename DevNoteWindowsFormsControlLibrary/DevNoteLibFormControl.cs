...
{
    public partial class DevNoteLibFormControl : UserControl
    {
        ScintillaNET.Scintilla TextArea;
        public DevNoteLibFormControl()
        {
            InitializeComponent();
      ...
      //  ScintillaNET.Scintilla TextArea;
        ...
        private void WFProfilesBindingNavigatorSaveItem_Click_1(object sender, EventArgs e)
        {
            ...
            if( wFProfilesBindingSource.Current!=null)
            {
                var wf = (WFProfile)wFProfilesBindingSource.Current;
                if (wf.Id > 0)
                {
                    //update
                    isInsert = false;
            ...
            if(isInsert)
            {
                ...
                WFProfile newWF = new WFProfile();
               // newWF.FileName = txt

              //  MyDB.WFProfiles.Add(wf);
